...
* StickC-Plus / StickS3 + Hat Mini JoyC
...
2. When building for M5StickS3, the external I2C pins are taken from M5Unified (`M5.Ex_I2C`) so the joystick HAT wiring stays board-aware.
3. When flashing, specify the baud rate as `1500000`.
