...
void app_main(void)
{
    ...
    M5.begin();
    M5.Power.begin();
    M5.Power.setExtOutput(true);  // enable external port power for JoyC / Grove devices
    ...
    joystick_data = joystick_init(0, 26);  // M5StickC Plus + Hat Mini JoyC legacy external I2C pins
